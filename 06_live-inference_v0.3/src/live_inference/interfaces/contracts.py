...
DISPLAY_ARTIFACT_MODEL_ROI_REPR_BEFORE_TRANSFORM = "model_roi_repr_before_transform"
DISPLAY_ARTIFACT_MODEL_ROI_REPR_AFTER_TRANSFORM = "model_roi_repr_after_transform"
DISPLAY_ARTIFACT_MODEL_FOREGROUND_MASK_BEFORE_TRANSFORM = (
    "model_foreground_mask_before_transform"
)
DISPLAY_ARTIFACT_MODEL_FOREGROUND_MASK_AFTER_TRANSFORM = (
    "model_foreground_mask_after_transform"
)
DISPLAY_ARTIFACT_MODEL_ORIENTATION_SOURCE_BEFORE_TRANSFORM = (
    "model_orientation_source_before_transform"
)
DISPLAY_ARTIFACT_MODEL_ORIENTATION_SOURCE_AFTER_TRANSFORM = (
    "model_orientation_source_after_transform"
)
DISPLAY_DEBUG_ARTIFACT_KEYS = (
    ...
    DISPLAY_ARTIFACT_MODEL_ROI_REPR_BEFORE_TRANSFORM,
    DISPLAY_ARTIFACT_MODEL_ROI_REPR_AFTER_TRANSFORM,
    DISPLAY_ARTIFACT_MODEL_FOREGROUND_MASK_BEFORE_TRANSFORM,
    DISPLAY_ARTIFACT_MODEL_FOREGROUND_MASK_AFTER_TRANSFORM,
    DISPLAY_ARTIFACT_MODEL_ORIENTATION_SOURCE_BEFORE_TRANSFORM,
    DISPLAY_ARTIFACT_MODEL_ORIENTATION_SOURCE_AFTER_TRANSFORM,
...
ROI_CANDIDATE_SOURCE_FIELD = "candidate_source"
ROI_CANDIDATE_SOURCE_FOREGROUND_COMPONENT = "foreground_component"
ROI_CANDIDATE_SOURCE_EDGE_CONTOUR = "edge_contour"
...
PREPROCESSING_METADATA_RAW_FOREGROUND_BBOX_XYXY_PX = "raw_foreground_bbox_xyxy_px"
PREPROCESSING_METADATA_RAW_FOREGROUND_BBOX_INCLUSIVE_XYXY_PX = (
    "raw_foreground_bbox_inclusive_xyxy_px"
)
PREPROCESSING_METADATA_RAW_FOREGROUND_AREA_PX = "raw_foreground_area_px"
PREPROCESSING_METADATA_MODEL_FOREGROUND_BBOX_XYXY_PX = (
    "model_foreground_bbox_xyxy_px"
)
PREPROCESSING_METADATA_MODEL_FOREGROUND_BBOX_INCLUSIVE_XYXY_PX = (
    "model_foreground_bbox_inclusive_xyxy_px"
)
PREPROCESSING_METADATA_MODEL_FOREGROUND_AREA_PX = "model_foreground_area_px"
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_ENABLED = (
    "model_representation_transform_enabled"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_SPACE_NAME = (
    "model_representation_transform_space_name"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_STAGE = (
    "model_representation_transform_stage"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_SCALE_X = (
    "model_representation_transform_scale_x"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_SCALE_Y = (
    "model_representation_transform_scale_y"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_ANCHOR = (
    "model_representation_transform_anchor"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_ANCHOR_XY_PX = (
    "model_representation_transform_anchor_xy_px"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_TRANSLATE_XY_PX = (
    "model_representation_transform_translate_xy_px"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_OUTPUT_WH_PX = (
    "model_representation_transform_output_wh_px"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_IMAGE_INTERPOLATION = (
    "model_representation_transform_image_interpolation"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_MASK_INTERPOLATION = (
    "model_representation_transform_mask_interpolation"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_IMAGE_FILL_VALUE = (
    "model_representation_transform_image_fill_value"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_MASK_FILL_VALUE = (
    "model_representation_transform_mask_fill_value"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_GEOMETRY_NORMALIZATION_SPACE = (
    "model_representation_transform_geometry_normalization_space"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_RECOMPUTE_GEOMETRY = (
    "model_representation_transform_recompute_geometry_from_transformed_mask"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_APPLIED = (
    "model_representation_transform_applied"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_ANCHOR_RESOLVED_XY_PX = (
    "model_representation_transform_anchor_resolved_xy_px"
)
PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_AFFINE_MATRIX_2X3 = (
    "model_representation_transform_affine_matrix_2x3"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_STATUS = (
    "foreground_mask_component_cleanup_status"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_APPLIED = (
    "foreground_mask_component_cleanup_applied"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_COUNT = (
    "foreground_mask_component_count"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_SOURCE = (
    "foreground_mask_component_cleanup_source"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_KEPT_LABEL = (
    "foreground_mask_component_cleanup_kept_label"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_KEPT_AREA_PX = (
    "foreground_mask_component_cleanup_kept_area_px"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_REMOVED_AREA_PX = (
    "foreground_mask_component_cleanup_removed_area_px"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_REMOVED_FRACTION = (
    "foreground_mask_component_cleanup_removed_fraction"
)
PREPROCESSING_METADATA_FOREGROUND_MASK_COMPONENT_CLEANUP_KEPT_ROI_BBOX_XYXY_PX = (
    "foreground_mask_component_cleanup_kept_roi_bbox_xyxy_px"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_MARGIN_PX = (
    "foreground_roi_border_guard_margin_px"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_STATUS = (
    "foreground_roi_border_guard_status"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_TOUCHES = (
    "foreground_roi_border_guard_touches"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_TOUCHES_TOP = (
    "foreground_roi_border_guard_touches_top"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_TOUCHES_BOTTOM = (
    "foreground_roi_border_guard_touches_bottom"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_TOUCHES_LEFT = (
    "foreground_roi_border_guard_touches_left"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_TOUCHES_RIGHT = (
    "foreground_roi_border_guard_touches_right"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_ENFORCED = (
    "foreground_roi_border_guard_enforced"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_ACTION = (
    "foreground_roi_border_guard_action"
)
PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_WARNING = (
    "foreground_roi_border_guard_warning"
)
...
__all__ = [
    ...
    "PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_TOUCHES_TOP",
    "PREPROCESSING_METADATA_FOREGROUND_ROI_BORDER_GUARD_WARNING",
    "PREPROCESSING_METADATA_MODEL_FOREGROUND_AREA_PX",
    "PREPROCESSING_METADATA_MODEL_FOREGROUND_BBOX_INCLUSIVE_XYXY_PX",
    "PREPROCESSING_METADATA_MODEL_FOREGROUND_BBOX_XYXY_PX",
    "PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_AFFINE_MATRIX_2X3",
    "PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_ANCHOR",
    ...
    "PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_STAGE",
    "PREPROCESSING_METADATA_MODEL_REPRESENTATION_TRANSFORM_TRANSLATE_XY_PX",
    "PREPROCESSING_METADATA_RAW_FOREGROUND_AREA_PX",
    "PREPROCESSING_METADATA_RAW_FOREGROUND_BBOX_INCLUSIVE_XYXY_PX",
    "PREPROCESSING_METADATA_RAW_FOREGROUND_BBOX_XYXY_PX",
...
__all__ = tuple(
    sorted(
        ...
        | {
            ...
            "PREPROCESSING_METADATA_LOCATOR_RESULT_ACCEPTED",
            "RoiCandidate",
            "ROI_CANDIDATE_SOURCE_EDGE_CONTOUR",
            "ROI_CANDIDATE_SOURCE_FIELD",
            "ROI_CANDIDATE_SOURCE_FOREGROUND_COMPONENT",
            "RoiLocator",
            "TraceManifest",
        }
    )
