...
ARTIFACT_GRAYSCALE_FRAME = contracts.DISPLAY_ARTIFACT_GRAYSCALE_FRAME
ARTIFACT_BACKGROUND_FRAME = contracts.DISPLAY_ARTIFACT_BACKGROUND_FRAME
ARTIFACT_BACKGROUND_DIFF = contracts.DISPLAY_ARTIFACT_BACKGROUND_DIFF
ARTIFACT_FOREGROUND_MASK = contracts.DISPLAY_ARTIFACT_FOREGROUND_MASK
ARTIFACT_EDGE_MAP = contracts.DISPLAY_ARTIFACT_EDGE_MAP
ARTIFACT_CANDIDATE_CONTOURS = contracts.DISPLAY_ARTIFACT_CANDIDATE_CONTOURS
ARTIFACT_CHOSEN_CONTOUR = contracts.DISPLAY_ARTIFACT_CHOSEN_CONTOUR
ARTIFACT_LOCATOR_OVERLAY = contracts.DISPLAY_ARTIFACT_LOCATOR_OVERLAY
...
ARTIFACT_LOCATOR_INPUT_RAW_OR_PRETRANSFORM = ARTIFACT_LOCATOR_INPUT_BEFORE_POLARITY
ARTIFACT_LOCATOR_INPUT_AFTER_MANUAL_MASK = "locator_input_after_manual_mask"
ARTIFACT_LOCATOR_INPUT_AFTER_BACKGROUND_REMOVAL = (
    "locator_input_after_background_removal"
)
ARTIFACT_LOCATOR_INPUT_AS_IS = "locator_input_as_is"
ARTIFACT_LOCATOR_INPUT_INVERTED = "locator_input_inverted"
ARTIFACT_LOCATOR_INPUT_SHEET_DARK_FOREGROUND = (
    "locator_input_sheet_dark_foreground"
)
ARTIFACT_FINAL_LOCATOR_INPUT = contracts.DISPLAY_ARTIFACT_FINAL_LOCATOR_INPUT
ARTIFACT_ROI_FCN_HEATMAP = "roi_fcn_heatmap"
ARTIFACT_ROI_FCN_HEATMAP_PRE_EXCLUSION = "roi_fcn_heatmap_pre_exclusion"
ARTIFACT_ROI_FCN_HEATMAP_POST_EXCLUSION = "roi_fcn_heatmap_post_exclusion"
...
ARTIFACT_MODEL_ROI_REPR_BEFORE_TRANSFORM = (
    contracts.DISPLAY_ARTIFACT_MODEL_ROI_REPR_BEFORE_TRANSFORM
)
...
ARTIFACT_MODEL_FOREGROUND_MASK_BEFORE_TRANSFORM = (
    contracts.DISPLAY_ARTIFACT_MODEL_FOREGROUND_MASK_BEFORE_TRANSFORM
)
ARTIFACT_MODEL_FOREGROUND_MASK_AFTER_TRANSFORM = (
    contracts.DISPLAY_ARTIFACT_MODEL_FOREGROUND_MASK_AFTER_TRANSFORM
)
ARTIFACT_MODEL_ORIENTATION_SOURCE_BEFORE_TRANSFORM = (
    contracts.DISPLAY_ARTIFACT_MODEL_ORIENTATION_SOURCE_BEFORE_TRANSFORM
)
ARTIFACT_MODEL_ORIENTATION_SOURCE_AFTER_TRANSFORM = (
    contracts.DISPLAY_ARTIFACT_MODEL_ORIENTATION_SOURCE_AFTER_TRANSFORM
)
...
__all__ = [
    ...
    "ARTIFACT_BACKGROUND_DIFF",
    "ARTIFACT_BACKGROUND_FRAME",
    "ARTIFACT_CANDIDATE_CONTOURS",
    "ARTIFACT_CHOSEN_CONTOUR",
