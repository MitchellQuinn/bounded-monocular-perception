    ...
    def _manifest_payload(
        ...
        *,
        ...
        return {
            ...
            "contract_version": contracts.LIVE_INFERENCE_CONTRACT_VERSION,
            ...
            "locator_kind": (
                preprocessing_metadata.get(contracts.PREPROCESSING_METADATA_LOCATOR_KIND)
                or context.get("locator_kind")
            ),
            "locator_parameters_revision": preprocessing_metadata.get(
                contracts.PREPROCESSING_METADATA_RUNTIME_PARAMETER_REVISION
            ),
            "locator_parameters": (
                _locator_parameters(preprocessing_metadata) or context.get("locator_parameters")
            ),
...
def _canonical_artifact_name(kind: str, source: Path) -> str:
    mapping = {
        ...
        contracts.DISPLAY_ARTIFACT_GRAYSCALE_FRAME: "grayscale_frame.png",
        contracts.DISPLAY_ARTIFACT_BACKGROUND_FRAME: "background_frame.png",
        contracts.DISPLAY_ARTIFACT_BACKGROUND_DIFF: "background_diff.png",
        contracts.DISPLAY_ARTIFACT_FOREGROUND_MASK: "foreground_mask.png",
        contracts.DISPLAY_ARTIFACT_EDGE_MAP: "edge_map.png",
        contracts.DISPLAY_ARTIFACT_CANDIDATE_CONTOURS: "candidate_contours.png",
        contracts.DISPLAY_ARTIFACT_CHOSEN_CONTOUR: "chosen_contour.png",
        contracts.DISPLAY_ARTIFACT_LOCATOR_OVERLAY: "locator_overlay.png",
...
def _locator_parameters(metadata: Mapping[str, Any]) -> dict[str, Any]:
    for raw in (
        metadata.get("locator_parameters"),
        _mapping_value(metadata, contracts.PREPROCESSING_METADATA_LOCATOR_METADATA).get(
            "locator_parameters"
        ),
        _mapping_value(
            _mapping_value(metadata, contracts.PREPROCESSING_METADATA_LOCATOR_METADATA).get(
