"""Standalone corpus shuffling for v2 training corpuses."""
...
from .config import ShuffleStageConfigV2, StageSummaryV2
from .paths import training_v2_run_paths



def run_shuffle_stage_v2(
    project_root: Path,
    source_run_name: str,
    output_run_name: str,
    config: ShuffleStageConfigV2 | None = None,
    *,
    log_sink: Callable[[str], None] | None = None,
) -> StageSummaryV2:
    """Shuffle one packed v2 training corpus into a new duplicate-free corpus."""

    stage_config = config or ShuffleStageConfigV2()
    ...
    source_paths = training_v2_run_paths(project_root, source_run)
    ...
    logger.log(f"Running v2 corpus shuffle from '{source_run}' to '{output_root_name}/{output_run}'")
