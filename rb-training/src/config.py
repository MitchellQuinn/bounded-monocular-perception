...
@dataclass
class TrainConfig:
    """Configuration for first-pass 2D CNN distance-regression training."""
    ...
    model_architecture_variant: str = "fast_v0_2"
...
@dataclass
class EvalConfig:
    """Configuration for evaluating a saved 2D CNN run."""
