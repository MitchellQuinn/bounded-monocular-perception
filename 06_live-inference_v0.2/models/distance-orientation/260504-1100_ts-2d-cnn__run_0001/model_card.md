...
- Training samples: 226971
- Validation samples: 47929
...
## Results (This Run)
- Validation accuracy (+/-0.10m): 0.628263
- Validation accuracy (+/-0.25m): 0.939682
- Validation accuracy (+/-0.50m): 0.999854
- Best validation MAE: 0.097556
- Best validation RMSE: 0.126273
- Best validation loss: 0.011139

- Validation mean angular error: 3.876998 deg
- Validation median angular error: 2.819916 deg
- Validation p95 angular error: 9.818097 deg
- Validation yaw accuracy (<= 5 deg): 0.746750
- Validation yaw accuracy (<= 10 deg): 0.952805
- Validation yaw accuracy (<= 15 deg): 0.989046
## Artifact Tracking
