"""Utility helpers for deterministic artifacts and environment capture."""
...
def set_random_seeds(seed: int) -> None:
    """Set reproducibility-friendly random seeds."""
    random.seed(seed)
    np.random.seed(seed)
...
def canonical_json_hash(payload: dict[str, Any]) -> str:
    """Hash a mapping via canonical JSON serialization."""
...
def git_metadata(repo_root: Path) -> dict[str, Any]:
    """Best-effort git state for artifact traceability."""
...
def environment_summary(device: str) -> dict[str, Any]:
    """Capture the runtime environment used for the run."""
    return {
