...
| [`incident-005-live-synthetic-apparent-scale-mismatch`](incidents/incident-005-live-synthetic-apparent-scale-mismatch/live-synthetic-apparent-scale-mismatch-report.md) | Investigated; follow-up sweeps recorded | Live/synthetic apparent-scale mismatch causing accepted live underprediction; latest sweep improves to MAE `0.080 m` but close-range bias remains |
