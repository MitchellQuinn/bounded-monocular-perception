"""Tri-stream distance + yaw v0.3 implementation."""
...
VARIANT = "tri_stream_yaw_v0_3"


class DistanceRegressorTriStreamYaw(TriStreamYawBase):
    """v0.3 tri-stream regressor with separated distance and yaw trunks."""
...
def build_model(**kwargs: object) -> nn.Module:
    """Build a v0.3 tri-stream yaw model from parsed topology params."""
