"""Tri-stream distance + yaw v0.2 implementation."""
...
VARIANT = "tri_stream_yaw_v0_2"


class DistanceRegressorTriStreamYaw(TriStreamYawBase):
    """v0.2 tri-stream regressor with camera trunk feeding distance and yaw."""
...
def build_model(**kwargs: object) -> nn.Module:
    """Build a v0.2 tri-stream yaw model from parsed topology params."""
